...
//    @Value("100") int oil;
////    @Autowired // byType, @Autowired 특징: 타입으로 먼저 검색, 여러 개인 경우 이름으로 검색(타입의 첫 문자를 소문자로 바꾼 것 - "engine")
////    @Qualifier("superEngine")
//    @Resource(name = "superEngine") // byName
//    Engine engine;
//    @Autowired Door[] doors;
//
//    public Car() {} // 생성자를 만들 때는 기본 생성자를 꼭 만들어 주자.
...
//        Car car = ac.getBean("car", Car.class); // byName, 뒤에 타입까지 써주면 형변환 필요 X
