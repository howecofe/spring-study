...
//    int autosaveInterval; // 자동 저장하는 간격
//    @Value("${autosave}")
//    boolean autosave;
//
//    @Override
...
//        Map<String, String> map = System.getenv(); // 시스템 변수 확인
...
//
///* [실행결과]
//car = Car{color='red', oil=100, engine=com.fastcampus.ch3.Engine@768fc0f2, doors=[com.fastcampus.ch3.Door@13b3d178]}
//car2 = Car{color='red', oil=100, engine=com.fastcampus.ch3.Engine@768fc0f2, doors=[com.fastcampus.ch3.Door@13b3d178]}
//ac.getBeanDefinitionNames() = [car, door, engine, homeController, superEngine, turboEngine, org.springframework.context.annotation.internalConfigurationAnnotationProcessor, org.springframework.context.annotation.internalAutowiredAnnotationProcessor, org.springframework.context.annotation.internalRequiredAnnotationProcessor, org.springframework.context.annotation.internalCommonAnnotationProcessor, org.springframework.context.event.internalEventListenerProcessor, org.springframework.context.event.internalEventListenerFactory]
